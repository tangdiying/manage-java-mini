package cn.tdywork.oa.module.infra.service.file;
...
import cn.tdywork.oa.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
import cn.tdywork.oa.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import cn.tdywork.oa.module.infra.dal.dataobject.file.FileConfigDO;
import cn.tdywork.oa.module.infra.dal.mysql.file.FileConfigMapper;
import cn.tdywork.oa.module.infra.framework.file.core.client.FileClient;
import cn.tdywork.oa.module.infra.framework.file.core.client.FileClientConfig;
import cn.tdywork.oa.module.infra.framework.file.core.client.FileClientFactory;
import cn.tdywork.oa.module.infra.framework.file.core.client.local.LocalFileClient;
import cn.tdywork.oa.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import cn.tdywork.oa.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static cn.tdywork.oa.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static cn.tdywork.oa.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("糖花源码")
