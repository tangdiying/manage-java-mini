package cn.tdywork.oa.module.infra.controller.admin.codegen;
...
import cn.tdywork.oa.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import cn.tdywork.oa.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import cn.tdywork.oa.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import cn.tdywork.oa.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.tdywork.oa.module.infra.convert.codegen.CodegenConvert;
...
import cn.tdywork.oa.module.infra.service.codegen.CodegenService;
...
import static cn.tdywork.oa.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static cn.tdywork.oa.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "oa"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "糖花")
    })
