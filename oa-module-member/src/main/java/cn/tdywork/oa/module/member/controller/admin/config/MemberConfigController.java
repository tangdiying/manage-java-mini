package cn.tdywork.oa.module.member.controller.admin.config;

import cn.tdywork.oa.framework.common.pojo.CommonResult;
import cn.tdywork.oa.module.member.controller.admin.config.vo.MemberConfigRespVO;
import cn.tdywork.oa.module.member.controller.admin.config.vo.MemberConfigSaveReqVO;
import cn.tdywork.oa.module.member.convert.config.MemberConfigConvert;
import cn.tdywork.oa.module.member.dal.dataobject.config.MemberConfigDO;
import cn.tdywork.oa.module.member.service.config.MemberConfigService;
