package cn.tdywork.oa.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import cn.tdywork.oa.framework.common.exception.enums.GlobalErrorCodeConstants;
...
import cn.tdywork.oa.module.iot.core.biz.dto.IotModbusPointRespDTO;
import cn.tdywork.oa.module.iot.core.enums.IotDeviceMessageMethodEnum;
import cn.tdywork.oa.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
import cn.tdywork.oa.module.iot.core.mq.message.IotDeviceMessage;
import cn.tdywork.oa.module.iot.core.topic.IotDeviceIdentity;
import cn.tdywork.oa.module.iot.core.util.IotDeviceAuthUtils;
import cn.tdywork.oa.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import cn.tdywork.oa.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import cn.tdywork.oa.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import cn.tdywork.oa.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import cn.tdywork.oa.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import cn.tdywork.oa.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import cn.tdywork.oa.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import cn.tdywork.oa.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import cn.tdywork.oa.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import cn.tdywork.oa.module.iot.gateway.service.device.IotDeviceService;
import cn.tdywork.oa.module.iot.gateway.service.device.message.IotDeviceMessageService;
import io.vertx.core.net.NetSocket;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static cn.tdywork.oa.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static cn.tdywork.oa.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static cn.tdywork.oa.framework.common.exception.util.ServiceExceptionUtil.invalidParamException;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link cn.tdywork.oa.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
