package cn.tdywork.oa.module.iot.core.messagebus.config;

import cn.tdywork.oa.framework.mq.redis.core.RedisMQTemplate;
import cn.tdywork.oa.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import cn.tdywork.oa.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import cn.tdywork.oa.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import cn.tdywork.oa.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import cn.tdywork.oa.module.iot.core.messagebus.core.IotMessageBus;
import cn.tdywork.oa.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import cn.tdywork.oa.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import cn.tdywork.oa.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "oa.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "oa.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    /**
     * 特殊：由于 OaRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see cn.tdywork.oa.framework.mq.redis.config.OaRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "oa.iot.message-bus", name = "type", havingValue = "redis")
