...
import cn.tdywork.oa.module.bpm.controller.admin.definition.vo.group.BpmUserGroupSaveReqVO;
import cn.tdywork.oa.module.bpm.controller.admin.definition.vo.group.BpmUserGroupPageReqVO;
import cn.tdywork.oa.module.bpm.dal.dataobject.definition.BpmUserGroupDO;
import cn.tdywork.oa.module.bpm.dal.mysql.definition.BpmUserGroupMapper;
...
import static cn.tdywork.oa.module.bpm.enums.ErrorCodeConstants.USER_GROUP_NOT_EXISTS;
...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testGetUserGroupPage() {
       ...
       // 测试 name 不匹配
       userGroupMapper.insert(cloneIgnoreId(dbUserGroup, o -> o.setName("糖花")));
       // 测试 status 不匹配
