package cn.tdywork.oa.module.bpm.service.task;
...
import cn.tdywork.oa.framework.common.util.date.DateUtils;
import cn.tdywork.oa.framework.common.util.json.JsonUtils;
import cn.tdywork.oa.framework.common.util.object.ObjectUtils;
import cn.tdywork.oa.framework.common.util.object.PageUtils;
import cn.tdywork.oa.framework.datapermission.core.annotation.DataPermission;
import cn.tdywork.oa.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import cn.tdywork.oa.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import cn.tdywork.oa.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import cn.tdywork.oa.module.bpm.controller.admin.task.vo.instance.*;
import cn.tdywork.oa.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import cn.tdywork.oa.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import cn.tdywork.oa.module.bpm.convert.task.BpmProcessInstanceConvert;
import cn.tdywork.oa.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.tdywork.oa.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import cn.tdywork.oa.module.bpm.enums.ErrorCodeConstants;
import cn.tdywork.oa.module.bpm.enums.definition.BpmModelTypeEnum;
import cn.tdywork.oa.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import cn.tdywork.oa.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import cn.tdywork.oa.module.bpm.enums.task.BpmReasonEnum;
import cn.tdywork.oa.module.bpm.enums.task.BpmTaskStatusEnum;
import cn.tdywork.oa.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import cn.tdywork.oa.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import cn.tdywork.oa.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import cn.tdywork.oa.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import cn.tdywork.oa.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import cn.tdywork.oa.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import cn.tdywork.oa.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import cn.tdywork.oa.module.bpm.framework.flowable.core.util.FlowableUtils;
import cn.tdywork.oa.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import cn.tdywork.oa.module.bpm.service.definition.BpmProcessDefinitionService;
import cn.tdywork.oa.module.bpm.service.message.BpmMessageService;
...
import static cn.tdywork.oa.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static cn.tdywork.oa.module.bpm.enums.ErrorCodeConstants.*;
import static cn.tdywork.oa.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static cn.tdywork.oa.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/oa-cloud/issues/ID1UYA
