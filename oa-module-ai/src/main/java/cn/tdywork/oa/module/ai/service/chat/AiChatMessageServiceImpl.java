package cn.tdywork.oa.module.ai.service.chat;
...
import cn.tdywork.oa.framework.tenant.core.util.TenantUtils;
import cn.tdywork.oa.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import cn.tdywork.oa.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import cn.tdywork.oa.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import cn.tdywork.oa.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import cn.tdywork.oa.module.ai.dal.dataobject.chat.AiChatConversationDO;
import cn.tdywork.oa.module.ai.dal.dataobject.chat.AiChatMessageDO;
import cn.tdywork.oa.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import cn.tdywork.oa.module.ai.dal.dataobject.model.AiChatRoleDO;
import cn.tdywork.oa.module.ai.dal.dataobject.model.AiModelDO;
import cn.tdywork.oa.module.ai.dal.dataobject.model.AiToolDO;
import cn.tdywork.oa.module.ai.dal.mysql.chat.AiChatMessageMapper;
import cn.tdywork.oa.module.ai.enums.ErrorCodeConstants;
import cn.tdywork.oa.module.ai.enums.model.AiPlatformEnum;
import cn.tdywork.oa.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import cn.tdywork.oa.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import cn.tdywork.oa.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import cn.tdywork.oa.module.ai.service.knowledge.AiKnowledgeDocumentService;
import cn.tdywork.oa.module.ai.service.knowledge.AiKnowledgeSegmentService;
import cn.tdywork.oa.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import cn.tdywork.oa.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import cn.tdywork.oa.module.ai.service.model.AiChatRoleService;
import cn.tdywork.oa.module.ai.service.model.AiModelService;
import cn.tdywork.oa.module.ai.service.model.AiToolService;
import cn.tdywork.oa.module.ai.util.AiUtils;
import cn.tdywork.oa.module.ai.util.FileTypeUtils;
...
import static cn.tdywork.oa.framework.common.pojo.CommonResult.error;
...
import static cn.tdywork.oa.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static cn.tdywork.oa.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 oa.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 oa.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
