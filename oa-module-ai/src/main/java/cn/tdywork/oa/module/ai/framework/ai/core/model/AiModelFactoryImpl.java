package cn.tdywork.oa.module.ai.framework.ai.core.model;
...
import cn.tdywork.oa.framework.common.util.spring.SpringUtils;
import cn.tdywork.oa.module.ai.enums.model.AiPlatformEnum;
import cn.tdywork.oa.module.ai.framework.ai.config.AiAutoConfiguration;
import cn.tdywork.oa.module.ai.framework.ai.config.OaAiProperties;
...
import cn.tdywork.oa.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.tdywork.oa.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            OaAiProperties.Midjourney properties = SpringUtil.getBean(OaAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(OaAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        OaAiProperties.DouBao properties = new OaAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(OaAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        OaAiProperties.HunYuan properties = new OaAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(OaAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        OaAiProperties.SiliconFlow properties = new OaAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(OaAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        OaAiProperties.XingHuo properties = new OaAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(OaAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        OaAiProperties.BaiChuan properties = new OaAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(OaAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        OaAiProperties.Gemini properties = SpringUtil.getBean(OaAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        OaAiProperties.Grok properties = new OaAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
