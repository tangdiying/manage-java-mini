package cn.tdywork.oa.module.mp.service.account;
...
import cn.tdywork.oa.module.mp.convert.account.MpAccountConvert;
import cn.tdywork.oa.module.mp.dal.dataobject.account.MpAccountDO;
import cn.tdywork.oa.module.mp.dal.mysql.account.MpAccountMapper;
import cn.tdywork.oa.module.mp.enums.ErrorCodeConstants;
...
import static cn.tdywork.oa.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 oa-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
