package cn.tdywork.oa.module.erp.controller.admin.stock.vo.out;
...
import static cn.tdywork.oa.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockOutRespVO {
    ...
    @Schema(description = "客户名称", example = "糖花")
    @ExcelProperty("客户名称")
    ...
    @Schema(description = "创建人", example = "糖花")
    private String creator;
    @Schema(description = "创建人名称", example = "糖花")
