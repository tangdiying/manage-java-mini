...
import cn.tdywork.oa.framework.common.util.date.LocalDateTimeUtils;
...
import cn.tdywork.oa.module.pay.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
...
import cn.tdywork.oa.module.pay.convert.order.PayOrderConvert;
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://gitee.com/zhijiantianya/oa-cloud/issues/I8SM9H 场景
