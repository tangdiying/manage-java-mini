...
import cn.tdywork.oa.module.mes.controller.admin.pro.task.vo.MesProTaskIssuePageReqVO;
import cn.tdywork.oa.module.mes.controller.admin.pro.task.vo.MesProTaskIssueRespVO;
import cn.tdywork.oa.module.mes.controller.admin.pro.task.vo.MesProTaskIssueSaveReqVO;
...
import cn.tdywork.oa.module.mes.dal.dataobject.pro.task.MesProTaskIssueDO;
...
public class MesProTaskIssueController {
    ...
    private List<MesProTaskIssueRespVO> buildIssueRespVOList(List<MesProTaskIssueDO> list) {
        ...
        // 拼接 VO
        return cn.tdywork.oa.framework.common.util.collection.CollectionUtils.convertList(list, issue -> {
