...
import cn.tdywork.oa.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO;
import cn.tdywork.oa.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLineSaveReqVO;
...
import cn.tdywork.oa.module.mes.dal.mysql.wm.productsales.MesWmProductSalesLineMapper;
import cn.tdywork.oa.module.mes.enums.qc.MesQcCheckResultEnum;
...
import cn.tdywork.oa.module.mes.dal.dataobject.wm.salesnotice.MesWmSalesNoticeLineDO;
import cn.tdywork.oa.module.mes.service.wm.salesnotice.MesWmSalesNoticeLineService;
...
public class MesWmProductSalesLineServiceImpl implements MesWmProductSalesLineService {
    ...
    @Override
    public cn.tdywork.oa.framework.common.pojo.PageResult<MesWmProductSalesLineDO> getProductSalesLinePage(
        ...
        if (pageReqVO.getSalesId() == null && pageReqVO.getClientId() != null) {
            ...
            if (CollUtil.isEmpty(salesList)) {
                return cn.tdywork.oa.framework.common.pojo.PageResult.empty();
            }
