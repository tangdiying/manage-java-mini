...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.tdywork.oa";
    private static final String ARTIFACT_ID = "oa";
    private static final String PACKAGE_NAME = "cn.tdywork.oa";
    private static final String TITLE = "OA管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.tdywork.oa";
        String artifactIdNew = "oa";
        String packageNameNew = "cn.tdywork.oa";
