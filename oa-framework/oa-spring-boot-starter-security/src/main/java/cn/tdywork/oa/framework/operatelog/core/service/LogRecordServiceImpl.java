package cn.tdywork.oa.framework.operatelog.core.service;

import cn.tdywork.oa.framework.common.biz.system.logger.OperateLogCommonApi;
...
public class LogRecordServiceImpl implements ILogRecordService {
    ...
    public static void fillModuleFields(OperateLogCreateReqDTO reqDTO, LogRecord logRecord) {
        ...
        reqDTO.setAction(logRecord.getAction());// 操作内容，例如：修改编号为 1 的用户信息，将性别从男改成女，将姓名从糖花改成源码。
