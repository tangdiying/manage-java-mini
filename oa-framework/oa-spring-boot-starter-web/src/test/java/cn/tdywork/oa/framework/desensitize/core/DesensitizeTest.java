package cn.tdywork.oa.framework.desensitize.core;

import cn.tdywork.oa.framework.common.util.json.JsonUtils;
import cn.tdywork.oa.framework.desensitize.core.annotation.Address;
import cn.tdywork.oa.framework.desensitize.core.regex.annotation.EmailDesensitize;
import cn.tdywork.oa.framework.desensitize.core.regex.annotation.RegexDesensitize;
import cn.tdywork.oa.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("糖花源码");
        ...
        desensitizeDemo.setRegex("你好，我是糖花源码");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("糖花源码");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "糖花源码", replacer = "*")
