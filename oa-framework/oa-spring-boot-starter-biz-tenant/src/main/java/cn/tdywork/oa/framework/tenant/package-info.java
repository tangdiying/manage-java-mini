 ...
 *      1）Spring Async：
 *          {@link cn.tdywork.oa.framework.quartz.config.OaAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 OaSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package cn.tdywork.oa.framework.tenant;
