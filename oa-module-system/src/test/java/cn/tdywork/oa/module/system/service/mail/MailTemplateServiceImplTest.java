package cn.tdywork.oa.module.system.service.mail;
...
import cn.tdywork.oa.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import cn.tdywork.oa.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import cn.tdywork.oa.module.system.dal.dataobject.mail.MailTemplateDO;
import cn.tdywork.oa.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static cn.tdywork.oa.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("糖花")));
        // 测试 code 不匹配
