package cn.tdywork.oa.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.tdywork.oa.framework.common.enums.CommonStatusEnum;
import cn.tdywork.oa.framework.common.exception.ServiceException;
import cn.tdywork.oa.framework.common.pojo.PageResult;
import cn.tdywork.oa.framework.common.util.collection.ArrayUtils;
import cn.tdywork.oa.framework.common.util.collection.CollectionUtils;
import cn.tdywork.oa.framework.test.core.ut.BaseDbUnitTest;
import cn.tdywork.oa.module.infra.api.config.ConfigApi;
import cn.tdywork.oa.module.infra.api.file.FileApi;
import cn.tdywork.oa.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.tdywork.oa.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.tdywork.oa.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.tdywork.oa.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.tdywork.oa.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.tdywork.oa.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import cn.tdywork.oa.module.system.dal.dataobject.dept.DeptDO;
import cn.tdywork.oa.module.system.dal.dataobject.dept.PostDO;
import cn.tdywork.oa.module.system.dal.dataobject.dept.UserPostDO;
import cn.tdywork.oa.module.system.dal.dataobject.tenant.TenantDO;
import cn.tdywork.oa.module.system.dal.dataobject.user.AdminUserDO;
import cn.tdywork.oa.module.system.dal.mysql.dept.UserPostMapper;
import cn.tdywork.oa.module.system.dal.mysql.user.AdminUserMapper;
import cn.tdywork.oa.module.system.enums.common.SexEnum;
import cn.tdywork.oa.module.system.service.dept.DeptService;
import cn.tdywork.oa.module.system.service.dept.PostService;
import cn.tdywork.oa.module.system.service.oauth2.OAuth2TokenService;
import cn.tdywork.oa.module.system.service.permission.PermissionService;
import cn.tdywork.oa.module.system.service.tenant.TenantService;
...
import static cn.tdywork.oa.framework.common.util.collection.SetUtils.asSet;
import static cn.tdywork.oa.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.tdywork.oa.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.tdywork.oa.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.tdywork.oa.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.tdywork.oa.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.tdywork.oa.framework.test.core.util.RandomUtils.*;
import static cn.tdywork.oa.module.system.enums.ErrorCodeConstants.*;
import static cn.tdywork.oa.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("oayuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("oayuanma");
        ...
        assertEquals("oayuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("oayuanma"))).thenReturn("java");
