package cn.tdywork.oa.module.system.service.tenant;

import cn.tdywork.oa.framework.common.enums.CommonStatusEnum;
import cn.tdywork.oa.framework.common.pojo.PageResult;
import cn.tdywork.oa.framework.tenant.config.TenantProperties;
...
import cn.tdywork.oa.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import cn.tdywork.oa.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import cn.tdywork.oa.module.system.dal.dataobject.permission.MenuDO;
import cn.tdywork.oa.module.system.dal.dataobject.permission.RoleDO;
import cn.tdywork.oa.module.system.dal.dataobject.tenant.TenantDO;
import cn.tdywork.oa.module.system.dal.dataobject.tenant.TenantPackageDO;
import cn.tdywork.oa.module.system.dal.mysql.tenant.TenantMapper;
import cn.tdywork.oa.module.system.enums.permission.RoleCodeEnum;
import cn.tdywork.oa.module.system.enums.permission.RoleTypeEnum;
import cn.tdywork.oa.module.system.service.permission.MenuService;
import cn.tdywork.oa.module.system.service.permission.PermissionService;
import cn.tdywork.oa.module.system.service.permission.RoleService;
import cn.tdywork.oa.module.system.service.tenant.handler.TenantInfoHandler;
import cn.tdywork.oa.module.system.service.tenant.handler.TenantMenuHandler;
import cn.tdywork.oa.module.system.service.user.AdminUserService;
...
import static cn.tdywork.oa.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("糖花", user.getNickname());
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("糖花"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("糖花");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
