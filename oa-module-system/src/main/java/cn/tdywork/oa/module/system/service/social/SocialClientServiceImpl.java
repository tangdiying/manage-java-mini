package cn.tdywork.oa.module.system.service.social;
...
import cn.tdywork.oa.framework.common.util.cache.CacheUtils;
import cn.tdywork.oa.framework.common.util.http.HttpUtils;
import cn.tdywork.oa.framework.common.util.object.BeanUtils;
import cn.tdywork.oa.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.tdywork.oa.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import cn.tdywork.oa.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.tdywork.oa.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.tdywork.oa.module.system.dal.dataobject.social.SocialClientDO;
import cn.tdywork.oa.module.system.dal.mysql.social.SocialClientMapper;
import cn.tdywork.oa.module.system.dal.redis.RedisKeyConstants;
import cn.tdywork.oa.module.system.enums.social.SocialTypeEnum;
import cn.tdywork.oa.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.tdywork.oa.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.tdywork.oa.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${oa.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${oa.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/oa-cloud/pulls/230
