...
import cn.tdywork.oa.framework.ip.core.utils.AreaUtils;
import cn.tdywork.oa.module.member.api.address.dto.MemberAddressRespDTO;
import cn.tdywork.oa.module.member.api.user.dto.MemberUserRespDTO;
import cn.tdywork.oa.module.pay.api.order.dto.PayOrderCreateReqDTO;
import cn.tdywork.oa.module.pay.enums.DictTypeConstants;
import cn.tdywork.oa.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import cn.tdywork.oa.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import cn.tdywork.oa.module.product.api.sku.dto.ProductSkuRespDTO;
import cn.tdywork.oa.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import cn.tdywork.oa.module.product.api.spu.dto.ProductSpuRespDTO;
import cn.tdywork.oa.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import cn.tdywork.oa.module.trade.api.order.dto.TradeOrderRespDTO;
import cn.tdywork.oa.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import cn.tdywork.oa.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import cn.tdywork.oa.module.trade.controller.admin.order.vo.*;
import cn.tdywork.oa.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import cn.tdywork.oa.module.trade.controller.app.order.vo.*;
import cn.tdywork.oa.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import cn.tdywork.oa.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import cn.tdywork.oa.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import cn.tdywork.oa.module.trade.framework.order.config.TradeOrderProperties;
import cn.tdywork.oa.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static cn.tdywork.oa.framework.common.util.collection.CollectionUtils.convertMap;
import static cn.tdywork.oa.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static cn.tdywork.oa.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/oacode/oa-mall-uniapp/issues/ICY7SJ
