package cn.tdywork.oa.module.promotion.controller.app.article.vo.article;
...
public class AppArticleRespVO {
    ...
    @Schema(description = "文章标题", requiredMode = Schema.RequiredMode.REQUIRED, example = "糖花源码 - 促销模块")
    private String title;

    @Schema(description = "文章作者", requiredMode = Schema.RequiredMode.REQUIRED, example = "糖花源码")
